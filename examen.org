...
2. Un cambio en un elemento <textarea> y/o <select> X
...
2. El fadeTo() a diferencia del fadeIn puede controlar la transparencia     X
...
2. Un conjunto de plantillas de estilo  X
